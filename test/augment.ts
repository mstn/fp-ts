...
describe('augment', () => {
  ...
  it('Chain', () => {
    const { chain$, chainFirst$, flatten } = augment(array)
  ...
  it('Extend', () => {
    const { extend$, duplicate } = augment(array)
  ...
  it('Bifunctor', () => {
    const { bimap$, mapLeft$ } = augment(either)
  ...
  it('Foldable', () => {
    const { reduce$, foldMap$, reduceRight$ } = augment(array)
  ...
  it('FoldableWithIndex', () => {
    const { reduceWithIndex$, foldMapWithIndex$, reduceRightWithIndex$ } = augment(array)
  ...
  it('Alt', () => {
    const { alt$ } = augment(array)
    assert.deepStrictEqual(alt$(() => [4, 5, 6])([1, 2, 3]), [1, 2, 3, 4, 5, 6])
  })

  it('Filterable', () => {
    const { filter$, filterMap$, partition$, partitionMap$ } = augment(array)
  ...
  it('FilterableWithIndex', () => {
    const { filterWithIndex$, filterMapWithIndex$, partitionWithIndex$, partitionMapWithIndex$ } = augment(array)
