 ...
 */
function elem(E) {
    return function (a) { return function (ma) { return (isLeft(ma) ? false : E.equals(a, ma.right)); }; };
}
exports.elem = elem;
...
exports.either = {
    ...
    bimap: function (fla, f, g) { return (isLeft(fla) ? left(f(fla.left)) : right(g(fla.right))); },
    mapLeft: function (fla, f) { return (isLeft(fla) ? left(f(fla.left)) : fla); },
...
var _a = pipeable_1.pipeable(exports.either), alt = _a.alt, ap = _a.ap, apFirst = _a.apFirst, apSecond = _a.apSecond, bimap = _a.bimap, chain = _a.chain, chainFirst = _a.chainFirst, duplicate = _a.duplicate, extend = _a.extend, flatten = _a.flatten, foldMap = _a.foldMap, map = _a.map, mapLeft = _a.mapLeft, reduce = _a.reduce, reduceRight = _a.reduceRight;
exports.alt = alt;
exports.ap = ap;
