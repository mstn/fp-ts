...
function getShow(S) {
    return {
        show: function (r) {
            var elements = collect(function (k, a) { return Show_1.showString.show(k) + ": " + S.show(a); })(r).join(', ');
 ...
 * @since 2.0.0
 */
exports.toArray = collect(function (k, a) { return [k, a]; });
function toUnfoldable(unfoldable) {
    return function (r) {
        var arr = exports.toArray(r);
        var len = arr.length;
 ...
 * @since 2.0.0
 */
function hasOwnProperty(k) {
    return function (r) { return _hasOwnProperty.call(r, k); };
}
...
function pop(k) {
    return function (r) {
        var a = lookup(k)(r);
        return Option_1.isNone(a) ? Option_1.none : Option_1.some([a.value, remove(k)(r)]);
    };
}
exports.pop = pop;
/**
 ...
 */
function lookup(k) {
    return function (r) { return (_hasOwnProperty.call(r, k) ? Option_1.some(r[k]) : Option_1.none); };
}
...
function reduceRightWithIndex(b, f) {
    return function (fa) { return exports.record.reduceRightWithIndex(fa, b, f); };
}
...
function partitionMapWithIndex(f) {
    return function (fa) { return exports.record.partitionMapWithIndex(fa, f); };
}
exports.partitionMapWithIndex = partitionMapWithIndex;
function partitionWithIndex(predicateWithIndex) {
    return function (fa) { return exports.record.partitionWithIndex(fa, predicateWithIndex); };
}
exports.partitionWithIndex = partitionWithIndex;
function filterMapWithIndex(f) {
    return function (fa) { return exports.record.filterMapWithIndex(fa, f); };
}
exports.filterMapWithIndex = filterMapWithIndex;
function filterWithIndex(predicateWithIndex) {
    return function (fa) { return exports.record.filterWithIndex(fa, predicateWithIndex); };
}
 ...
 */
function elem(E) {
    return function (a) { return some(function (x) { return E.equals(x, a); }); };
}
exports.elem = elem;
/**
 * @since 2.0.0
...
exports.record = {
    ...
    reduceRight: function (fa, b, f) { return exports.record.reduceRightWithIndex(fa, b, function (_, a, b) { return f(a, b); }); },
    traverse: function (F) {
        var traverseWithIndexF = exports.record.traverseWithIndex(F);
