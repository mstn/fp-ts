...
export interface FilterWithIndex4<F extends URIS4, I> {
    <X, U, L, A, B extends A>(fa: Type4<F, X, U, L, A>, refinementWithIndex: RefinementWithIndex<I, A, B>): Type4<F, X, U, L, B>;
...
export interface PartitionWithIndex4<F extends URIS4, I> {
    <X, U, L, A, B extends A>(fa: Type4<F, X, U, L, A>, refinementWithIndex: RefinementWithIndex<I, A, B>): Separated<Type4<F, X, U, L, A>, Type4<F, X, U, L, B>>;
    <X, U, L, A>(fa: Type4<F, X, U, L, A>, predicateWithIndex: PredicateWithIndex<I, A>): Separated<Type4<F, X, U, L, A>, Type4<F, X, U, L, A>>;
}
export interface FilterableWithIndex4<F extends URIS4, I> extends FunctorWithIndex4<F, I>, Filterable4<F> {
    readonly partitionMapWithIndex: <RL, RR, X, U, L, A>(fa: Type4<F, X, U, L, A>, f: (i: I, a: A) => Either<RL, RR>) => Separated<Type4<F, X, U, L, RL>, Type4<F, X, U, L, RR>>;
    readonly partitionWithIndex: PartitionWithIndex4<F, I>;
    readonly filterMapWithIndex: <X, U, L, A, B>(fa: Type4<F, X, U, L, A>, f: (i: I, a: A) => Option<B>) => Type4<F, X, U, L, B>;
