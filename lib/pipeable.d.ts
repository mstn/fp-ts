...
import { FilterableWithIndex, FilterableWithIndex1, FilterableWithIndex2, FilterableWithIndex2C, FilterableWithIndex3, PredicateWithIndex, RefinementWithIndex, FilterableWithIndex4 } from './FilterableWithIndex';
...
export interface PipeableApply4<F extends URIS4> extends PipeableFunctor4<F> {
    readonly ap: <X, U, L, A>(fa: Type4<F, X, U, L, A>) => <B>(fab: Type4<F, X, U, L, (a: A) => B>) => Type4<F, X, U, L, B>;
...
export interface PipeableChain4<F extends URIS4> extends PipeableApply4<F> {
    readonly chain: <X, U, L, A, B>(f: (a: A) => Type4<F, X, U, L, B>) => (ma: Type4<F, X, U, L, A>) => Type4<F, X, U, L, B>;
    readonly chainFirst: <X, U, L, A, B>(f: (a: A) => Type4<F, X, U, L, B>) => (ma: Type4<F, X, U, L, A>) => Type4<F, X, U, L, A>;
...
export interface PipeableExtend4<F extends URIS4> extends PipeableFunctor4<F> {
    readonly extend: <X, U, L, A, B>(f: (fa: Type4<F, X, U, L, A>) => B) => (ma: Type4<F, X, U, L, A>) => Type4<F, X, U, L, B>;
...
export interface PipeableBifunctor4<F extends URIS4> {
    readonly bimap: <L, A, M, B>(f: (l: L) => M, g: (a: A) => B) => <X, U>(fa: Type4<F, X, U, L, A>) => Type4<F, X, U, M, B>;
...
export interface PipeableFilterable4<F extends URIS4> {
    ...
    readonly partition: {
        <A, B extends A>(refinement: Refinement<A, B>): <X, U, L>(fa: Type4<F, X, U, L, A>) => Separated<Type4<F, X, U, L, A>, Type4<F, X, U, L, B>>;
        <A>(predicate: Predicate<A>): <X, U, L>(fa: Type4<F, X, U, L, A>) => Separated<Type4<F, X, U, L, A>, Type4<F, X, U, L, A>>;
    };
    readonly partitionMap: <A, RL, RR>(f: (a: A) => Either<RL, RR>) => <X, U, L>(fa: Type4<F, X, U, L, A>) => Separated<Type4<F, X, U, L, RL>, Type4<F, X, U, L, RR>>;
}
...
export interface PipeableProfunctor4<F extends URIS4> extends PipeableFunctor4<F> {
    readonly promap: <X, U, A, B, C, D>(f: (a: A) => B, g: (c: C) => D) => (fbc: Type4<F, X, U, B, C>) => Type4<F, X, U, A, D>;
}
