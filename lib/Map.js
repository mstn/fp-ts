...
function member(E) {
    ...
    return function (k) { return function (m) { return Option_1.isSome(lookupE(k)(m)); }; };
}
 ...
 */
function elem(E) {
    return function (a) { return function (m) {
        var values = m.values();
        var e;
...
function pop(E) {
    ...
    return function (k) { return function (m) { return Option_1.option.map(lookupE(k)(m), function (a) { return [a, removeE(k)(m)]; }); }; };
}
exports.pop = pop;
/**
...
function lookup(E) {
    var lookupWithKeyE = lookupWithKey(E);
    return function (k) { return function (m) { return Option_1.option.map(lookupWithKeyE(k)(m), function (_a) {
        var _ = _a[0], a = _a[1];
        return a;
    }); }; };
}
...
function getFilterableWithIndex() {
    return __assign({}, exports.map_, { _L: function_1.phantom, mapWithIndex: _mapWithIndex, partitionMapWithIndex: _partitionMapWithIndex, partitionWithIndex: _partitionWithIndex, filterMapWithIndex: _filterMapWithIndex, filterWithIndex: _filterWithIndex });
}
...
function getWitherable(O) {
    ...
    return __assign({}, exports.map_, { _L: function_1.phantom, reduce: function (fa, b, f) { return reduceWithIndex(fa, b, function (_, b, a) { return f(b, a); }); }, foldMap: function (M) {
...
var _a = pipeable_1.pipeable(exports.map_), filter = _a.filter, filterMap = _a.filterMap, map = _a.map, partition = _a.partition, partitionMap = _a.partitionMap;
