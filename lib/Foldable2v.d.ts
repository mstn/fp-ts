 ...
 * @deprecated
 */
export declare function elem<F extends URIS3, A>(E: Eq<A>, F: Foldable2v3<F>): <U, L>(a: A, fa: Type3<F, U, L, A>) => boolean;
/** @deprecated */
export declare function elem<F extends URIS3, A, U, L>(E: Eq<A>, F: Foldable2v3C<F, U, L>): (a: A, fa: Type3<F, U, L, A>) => boolean;
/** @deprecated */
export declare function elem<F extends URIS2, A>(E: Eq<A>, F: Foldable2v2<F>): <L>(a: A, fa: Type2<F, L, A>) => boolean;
/** @deprecated */
export declare function elem<F extends URIS2, A, L>(E: Eq<A>, F: Foldable2v2C<F, L>): (a: A, fa: Type2<F, L, A>) => boolean;
/** @deprecated */
export declare function elem<F extends URIS, A>(E: Eq<A>, F: Foldable2v1<F>): (a: A, fa: Type<F, A>) => boolean;
/** @deprecated */
 ...
 * @deprecated
 */
export declare function member<F extends URIS3, A>(E: Eq<A>, F: Foldable2v3<F>): <U, L>(a: A, fa: Type3<F, U, L, A>) => boolean;
/** @deprecated */
export declare function member<F extends URIS3, A, U, L>(E: Eq<A>, F: Foldable2v3C<F, U, L>): (a: A, fa: Type3<F, U, L, A>) => boolean;
/** @deprecated */
export declare function member<F extends URIS2, A>(E: Eq<A>, F: Foldable2v2<F>): <L>(a: A, fa: Type2<F, L, A>) => boolean;
/** @deprecated */
export declare function member<F extends URIS2, A, L>(E: Eq<A>, F: Foldable2v2C<F, L>): (a: A, fa: Type2<F, L, A>) => boolean;
/** @deprecated */
export declare function member<F extends URIS, A>(E: Eq<A>, F: Foldable2v1<F>): (a: A, fa: Type<F, A>) => boolean;
/** @deprecated */
