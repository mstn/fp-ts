 ...
 * @since 1.0.0
 */
export declare function elem<F extends URIS3, A>(F: Foldable3<F>, E: Eq<A>): <U, L>(a: A, fa: Type3<F, U, L, A>) => boolean;
export declare function elem<F extends URIS3, A, U, L>(F: Foldable3C<F, U, L>, E: Eq<A>): (a: A, fa: Type3<F, U, L, A>) => boolean;
export declare function elem<F extends URIS2, A>(F: Foldable2<F>, E: Eq<A>): <L>(a: A, fa: Type2<F, L, A>) => boolean;
export declare function elem<F extends URIS2, A, L>(F: Foldable2C<F, L>, E: Eq<A>): (a: A, fa: Type2<F, L, A>) => boolean;
export declare function elem<F extends URIS, A>(F: Foldable1<F>, E: Eq<A>): (a: A, fa: Type<F, A>) => boolean;
